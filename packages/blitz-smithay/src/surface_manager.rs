...
impl WaylandSurfaceManager {
    ...
    pub fn track_damage(&mut self, surface_id: ObjectId, damage: &[Rectangle<i32, i32>]) {
...
impl WaylandSurface {
    ...
    pub fn add_damage_region(&mut self, region: Rectangle<i32, i32>) {
...
pub struct SurfaceDamageTracker {
    surface_damages: HashMap<ObjectId, Vec<Rectangle<i32, i32>>>,
    accumulated_damage: Vec<Rectangle<i32, i32>>,
}
...
impl SurfaceDamageTracker {
    ...
    pub fn get_accumulated_damage(&self) -> &[Rectangle<i32, i32>] {
...
pub struct RenderElement {
    ...
    pub scale: f64,
    pub z_index: i32,
    pub damage_regions: Vec<Rectangle<i32, i32>>,
    pub opacity: f32,
